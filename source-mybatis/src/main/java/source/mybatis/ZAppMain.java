...
import source.mybatis.environmentConfig.DruidDataSource;
import source.mybatis.interceptors.ShowSql;
import source.mybatis.mapper.RoleMapper;
import source.mybatis.mapper.UserMapper;
...
public class ZAppMain {
  ...
  public static SqlSession getSqlSessionByConfig() throws Exception {
    ...
    configuration.addMappers("source.mybatis.mapper");
